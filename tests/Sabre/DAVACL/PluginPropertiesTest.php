...
class Sabre_DAVACL_PluginPropertiesTest extends PHPUnit_Framework_TestCase {
    ...
    function testCurrentUserPrincipal() {
        ...
        $this->assertType('Sabre_DAVACL_Property_Principal', $returnedProperties[200]['{DAV:}current-user-principal']);
    ...
    function testACL() {
        ...
        $this->assertType('Sabre_DAVACL_Property_ACL', $returnedProperties[200]['{DAV:}acl']);
    ...
    function testAlternateUriSet() {
        ...
        $this->assertType('Sabre_DAV_Property_HrefList', $returnedProperties[200]['{DAV:}alternate-URI-set']);
    ...
    function testPrincipalURL() {
        ...
        $this->assertType('Sabre_DAV_Property_Href', $returnedProperties[200]['{DAV:}principal-URL']);
    ...
    function testGroupMemberSet() {
        ...
        $this->assertType('Sabre_DAV_Property_HrefList', $returnedProperties[200]['{DAV:}group-member-set']);
    ...
    function testGroupMemberShip() {
        ...
        $this->assertType('Sabre_DAV_Property_HrefList', $returnedProperties[200]['{DAV:}group-membership']);
